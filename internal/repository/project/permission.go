...
// NewLoader creates a PermissionLoader backed by the given DB.
func NewLoader(db *sqlx.DB) repository.PermissionLoader {
...
// NewCRUD creates a PermissionRepository.
func NewCRUD(db *sqlx.DB) repository.PermissionRepository {
...
func (r *projectPermissionRepo) Update(ctx context.Context, p *project.ProjectPermission) error {
	...
	return repository.CheckRowsAffected(res, project.ErrPermissionNotFound)
}
