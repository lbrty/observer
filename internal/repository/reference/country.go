...
// NewCountry creates a CountryRepository.
func NewCountry(db *sqlx.DB) repository.CountryRepository {
...
func (r *countryRepo) Update(ctx context.Context, c *reference.Country) error {
	...
	return repository.CheckRowsAffected(res, reference.ErrCountryNotFound)
}
