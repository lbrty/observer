...
// NewOffice creates an OfficeRepository.
func NewOffice(db *sqlx.DB) repository.OfficeRepository {
...
func scanOffice(row interface{ Scan(dest ...any) error }) (*reference.Office, error) {
	...
	repository.TimesToUTC(&o.CreatedAt, &o.UpdatedAt)
	return &o, nil
}
...
func (r *officeRepo) Update(ctx context.Context, o *reference.Office) error {
	...
	return repository.CheckRowsAffected(res, reference.ErrOfficeNotFound)
}
