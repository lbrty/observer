...
// NewPlace creates a PlaceRepository.
func NewPlace(db *sqlx.DB) repository.PlaceRepository {
...
func (r *placeRepo) Update(ctx context.Context, p *reference.Place) error {
	...
	return repository.CheckRowsAffected(res, reference.ErrPlaceNotFound)
}
