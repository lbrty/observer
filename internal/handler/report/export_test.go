...
func TestExportHandler_ExportPeople_Success(t *testing.T) {
	...
	c, w := handlertest.NewTestContextWithParams(http.MethodGet, "/projects/"+projectID+"/export/people", nil, gin.Params{
...
func TestExportHandler_ExportSupportRecords_Success(t *testing.T) {
	...
	c, w := handlertest.NewTestContextWithParams(http.MethodGet, "/projects/"+projectID+"/export/support-records", nil, gin.Params{
		{Key: "project_id", Value: projectID},
	})
	c.Set(string(middleware.CtxCanExport), true)
...
func TestExportHandler_ExportPets_Success(t *testing.T) {
	...
	c, w := handlertest.NewTestContextWithParams(http.MethodGet, "/projects/"+projectID+"/export/pets", nil, gin.Params{
		{Key: "project_id", Value: projectID},
	})
	c.Set(string(middleware.CtxCanExport), true)
...
func TestExportHandler_ExportHouseholds_Success(t *testing.T) {
	...
	now := time.Now().UTC()
	ref := "HH-001"
	headID := handlertest.TestID().String()
	...
	c, w := handlertest.NewTestContextWithParams(http.MethodGet, "/projects/"+projectID+"/export/households", nil, gin.Params{
		{Key: "project_id", Value: projectID},
	})
	c.Set(string(middleware.CtxCanExport), true)
