...
func newCategoryHandler(ctrl *gomock.Controller) (*admin.CategoryHandler, *repomock.MockCategoryRepository) {
	repo := repomock.NewMockCategoryRepository(ctrl)
	uc := ucadmin.NewCategoryUseCase(repo)
	return admin.NewCategoryHandler(uc), repo
}
...
func TestCategoryHandler_List_Success(t *testing.T) {
	...
	repo.EXPECT().List(gomock.Any()).Return([]*reference.Category{
		{ID: handlertest.TestID().String(), Name: "IDP", Description: &desc, CreatedAt: now, UpdatedAt: now},
		{ID: handlertest.TestID().String(), Name: "Refugee", CreatedAt: now, UpdatedAt: now},
	}, nil)

	c, w := handlertest.NewTestContext(http.MethodGet, "/admin/categories", nil)
	h.List(c)
...
func TestCategoryHandler_Get_NotFound(t *testing.T) {
	...
	c, w := handlertest.NewTestContextWithParams(http.MethodGet, "/admin/categories/"+id, nil, gin.Params{
		{Key: "id", Value: id},
	})
	h.Get(c)
...
func TestCategoryHandler_Create_ValidationError(t *testing.T) {
	...
	c, w := handlertest.NewTestContext(http.MethodPost, "/admin/categories", map[string]any{})
	h.Create(c)
...
func TestCategoryHandler_Update_NotFound(t *testing.T) {
	...
	c, w := handlertest.NewTestContextWithParams(http.MethodPatch, "/admin/categories/"+id, map[string]any{
		"name": "Updated",
...
func TestCategoryHandler_Delete_NotFound(t *testing.T) {
	...
	c, w := handlertest.NewTestContextWithParams(http.MethodDelete, "/admin/categories/"+id, nil, gin.Params{
		{Key: "id", Value: id},
	})
	h.Delete(c)
