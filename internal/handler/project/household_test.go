...
func TestHouseholdHandler_List_Success(t *testing.T) {
	...
	repo.EXPECT().List(gomock.Any(), gomock.Any()).Return([]*household.Household{
		{ID: handlertest.TestID().String(), ProjectID: projectID, CreatedAt: now, UpdatedAt: now},
		{ID: handlertest.TestID().String(), ProjectID: projectID, CreatedAt: now, UpdatedAt: now},
	}, 2, nil)

	c, w := handlertest.NewTestContextWithParams(http.MethodGet, "/projects/"+projectID+"/households", nil, gin.Params{
...
func TestHouseholdHandler_Get_NotFound(t *testing.T) {
	...
	c, w := handlertest.NewTestContextWithParams(http.MethodGet, "/projects/x/households/"+id, nil, gin.Params{
		{Key: "id", Value: id},
	})
	h.Get(c)
...
func TestHouseholdHandler_Get_Success(t *testing.T) {
	...
	c, w := handlertest.NewTestContextWithParams(http.MethodGet, "/projects/"+projectID+"/households/"+id, nil, gin.Params{
		{Key: "project_id", Value: projectID},
		{Key: "id", Value: id},
	})
	h.Get(c)
...
func TestHouseholdHandler_Create_Success(t *testing.T) {
	...
	c, w := handlertest.NewTestContextWithParams(http.MethodPost, "/projects/"+projectID+"/households", map[string]any{
...
func TestHouseholdHandler_Update_NotFound(t *testing.T) {
	...
	c, w := handlertest.NewTestContextWithParams(http.MethodPatch, "/projects/x/households/"+id, map[string]any{
...
func TestHouseholdHandler_Update_Success(t *testing.T) {
	...
	refNum := "HH-002"
	c, w := handlertest.NewTestContextWithParams(http.MethodPatch, "/projects/"+projectID+"/households/"+id, map[string]any{
		"reference_number": refNum,
	}, gin.Params{
		{Key: "project_id", Value: projectID},
		{Key: "id", Value: id},
...
func TestHouseholdHandler_Delete_NotFound(t *testing.T) {
	...
	c, w := handlertest.NewTestContextWithParams(http.MethodDelete, "/projects/"+projectID+"/households/"+id, nil, gin.Params{
		{Key: "project_id", Value: projectID},
		{Key: "id", Value: id},
	})
	h.Delete(c)
...
func TestHouseholdHandler_AddMember_ValidationError(t *testing.T) {
	...
	id := handlertest.TestID().String()
	c, w := handlertest.NewTestContextWithParams(http.MethodPost, "/projects/x/households/"+id+"/members", map[string]any{}, gin.Params{
		{Key: "id", Value: id},
	})
	h.AddMember(c)
...
func TestHouseholdHandler_AddMember_Success(t *testing.T) {
	...
	c, w := handlertest.NewTestContextWithParams(http.MethodPost, "/projects/"+projectID+"/households/"+id+"/members", map[string]any{
		"person_id":    personID,
		"relationship": "spouse",
	}, gin.Params{
		{Key: "project_id", Value: projectID},
...
func TestHouseholdHandler_RemoveMember_NotFound(t *testing.T) {
	...
	c, w := handlertest.NewTestContextWithParams(http.MethodDelete, "/projects/"+projectID+"/households/"+id+"/members/"+personID, nil, gin.Params{
		{Key: "project_id", Value: projectID},
		{Key: "id", Value: id},
