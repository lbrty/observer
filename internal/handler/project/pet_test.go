...
func newPetHandler(ctrl *gomock.Controller) (*project.PetHandler, *repomock.MockPetRepository, *repomock.MockPetTagRepository) {
	...
	return project.NewPetHandler(uc, tagUC), petRepo, petTagRepo
}
...
func TestPetHandler_List_Success(t *testing.T) {
	...
	now := time.Now().UTC()
	id1 := handlertest.TestID().String()
	id2 := handlertest.TestID().String()
	...
	c, w := handlertest.NewTestContextWithParams(http.MethodGet, "/projects/"+projectID+"/pets", nil, gin.Params{
...
func TestPetHandler_Get_NotFound(t *testing.T) {
	...
	c, w := handlertest.NewTestContextWithParams(http.MethodGet, "/projects/x/pets/"+id, nil, gin.Params{
		{Key: "id", Value: id},
	})
	h.Get(c)
...
func TestPetHandler_Get_Success(t *testing.T) {
	...
	c, w := handlertest.NewTestContextWithParams(http.MethodGet, "/projects/"+projectID+"/pets/"+id, nil, gin.Params{
		{Key: "project_id", Value: projectID},
		{Key: "id", Value: id},
	})
	h.Get(c)
...
func TestPetHandler_Create_ValidationError(t *testing.T) {
	...
	projectID := handlertest.TestID().String()
	c, w := handlertest.NewTestContextWithParams(http.MethodPost, "/projects/"+projectID+"/pets", map[string]any{}, gin.Params{
		{Key: "project_id", Value: projectID},
	})
	h.Create(c)
...
func TestPetHandler_Create_Success(t *testing.T) {
	...
	c, w := handlertest.NewTestContextWithParams(http.MethodPost, "/projects/"+projectID+"/pets", map[string]any{
		"name": "Rex",
	}, gin.Params{
		{Key: "project_id", Value: projectID},
	})
...
func TestPetHandler_Update_NotFound(t *testing.T) {
	...
	c, w := handlertest.NewTestContextWithParams(http.MethodPatch, "/projects/x/pets/"+id, map[string]any{
		"name": "updated",
	}, gin.Params{
		{Key: "id", Value: id},
	})
...
func TestPetHandler_Update_Success(t *testing.T) {
	...
	c, w := handlertest.NewTestContextWithParams(http.MethodPatch, "/projects/"+projectID+"/pets/"+id, map[string]any{
		"name": "Rex Jr",
	}, gin.Params{
		{Key: "project_id", Value: projectID},
		{Key: "id", Value: id},
...
func TestPetHandler_Delete_NotFound(t *testing.T) {
	...
	c, w := handlertest.NewTestContextWithParams(http.MethodDelete, "/projects/"+projectID+"/pets/"+id, nil, gin.Params{
		{Key: "project_id", Value: projectID},
		{Key: "id", Value: id},
	})
	h.Delete(c)
...
func TestPetHandler_ListTags_Success(t *testing.T) {
	...
	c, w := handlertest.NewTestContextWithParams(http.MethodGet, "/projects/x/pets/"+id+"/tags", nil, gin.Params{
		{Key: "id", Value: id},
	})
	h.ListTags(c)
...
func TestPetHandler_ReplaceTags_ValidationError(t *testing.T) {
	...
	id := handlertest.TestID().String()
	c, w := handlertest.NewTestContextWithParams(http.MethodPut, "/projects/x/pets/"+id+"/tags", map[string]any{}, gin.Params{
		{Key: "id", Value: id},
	})
	h.ReplaceTags(c)
...
func TestPetHandler_ReplaceTags_Success(t *testing.T) {
	...
	c, w := handlertest.NewTestContextWithParams(http.MethodPut, "/projects/"+projectID+"/pets/"+id+"/tags", map[string]any{
		"ids": tagIDs,
	}, gin.Params{
		{Key: "project_id", Value: projectID},
		{Key: "id", Value: id},
