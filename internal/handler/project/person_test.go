...
func TestPersonHandler_List_Success(t *testing.T) {
	...
	c, w := handlertest.NewTestContextWithParams(http.MethodGet, "/projects/"+projectID+"/people", nil, gin.Params{
...
func TestPersonHandler_Get_NotFound(t *testing.T) {
	...
	c, w := handlertest.NewTestContextWithParams(http.MethodGet, "/projects/x/people/"+personID, nil, gin.Params{
...
func TestPersonHandler_Get_Success(t *testing.T) {
	...
	c, w := handlertest.NewTestContextWithParams(http.MethodGet, "/projects/"+projectID+"/people/"+p.ID, nil, gin.Params{
		{Key: "project_id", Value: projectID},
...
func TestPersonHandler_Create_ValidationError(t *testing.T) {
	...
	c, w := handlertest.NewTestContextWithParams(http.MethodPost, "/projects/"+projectID+"/people", map[string]any{}, gin.Params{
		{Key: "project_id", Value: projectID},
	})
...
func TestPersonHandler_Create_Success(t *testing.T) {
	...
	c, w := handlertest.NewTestContextWithParams(http.MethodPost, "/projects/"+projectID+"/people", map[string]any{
		"first_name": "Aman",
	}, gin.Params{
		{Key: "project_id", Value: projectID},
	})
...
func TestPersonHandler_Update_NotFound(t *testing.T) {
	...
	c, w := handlertest.NewTestContextWithParams(http.MethodPatch, "/projects/x/people/"+personID, map[string]any{
		"first_name": "Updated",
	}, gin.Params{
		{Key: "person_id", Value: personID},
	})
...
func TestPersonHandler_Update_Success(t *testing.T) {
	...
	c, w := handlertest.NewTestContextWithParams(http.MethodPatch, "/projects/"+projectID+"/people/"+p.ID, map[string]any{
		"first_name": "Updated",
	}, gin.Params{
		{Key: "project_id", Value: projectID},
		{Key: "person_id", Value: p.ID},
...
func TestPersonHandler_Delete_NotFound(t *testing.T) {
	...
	c, w := handlertest.NewTestContextWithParams(http.MethodDelete, "/projects/"+projectID+"/people/"+personID, nil, gin.Params{
		{Key: "project_id", Value: projectID},
		{Key: "person_id", Value: personID},
	})
...
func TestPersonHandler_Delete_Success(t *testing.T) {
	...
	c, w := handlertest.NewTestContextWithParams(http.MethodDelete, "/projects/"+projectID+"/people/"+p.ID, nil, gin.Params{
		{Key: "project_id", Value: projectID},
		{Key: "person_id", Value: p.ID},
	})
	deps.handler.Delete(c)
...
func TestPersonHandler_ReplaceCategories_Success(t *testing.T) {
	...
	c, w := handlertest.NewTestContextWithParams(http.MethodPut, "/projects/x/people/"+personID+"/categories", map[string]any{
		"ids": catIDs,
	}, gin.Params{
		{Key: "project_id", Value: "x"},
		{Key: "person_id", Value: personID},
...
func TestPersonHandler_ReplaceTags_Success(t *testing.T) {
	...
	c, w := handlertest.NewTestContextWithParams(http.MethodPut, "/projects/x/people/"+personID+"/tags", map[string]any{
		"ids": tagIDs,
	}, gin.Params{
		{Key: "project_id", Value: "x"},
		{Key: "person_id", Value: personID},
