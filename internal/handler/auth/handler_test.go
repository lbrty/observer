...
func newAuthHandler(d *authTestDeps) *auth.AuthHandler {
	return auth.NewAuthHandler(d.authUseCase(), handlertest.TestCookieConfig(), handlertest.TestJWTConfig())
}
...
func TestAuthHandler_Register_ValidationError(t *testing.T) {
	...
	c, w := handlertest.NewTestContext(http.MethodPost, "/auth/register", map[string]string{})
	h.Register(c)
...
func TestAuthHandler_Login_ValidationError(t *testing.T) {
	...
	c, w := handlertest.NewTestContext(http.MethodPost, "/auth/login", map[string]string{})
	h.Login(c)
...
func TestAuthHandler_Me_NoAuth(t *testing.T) {
	...
	c, w := handlertest.NewTestContext(http.MethodGet, "/auth/me", nil)
	h.Me(c)
...
func TestAuthHandler_RefreshToken_NoToken(t *testing.T) {
	...
	c, w := handlertest.NewTestContext(http.MethodPost, "/auth/refresh", nil)
	h.RefreshToken(c)
...
func TestAuthHandler_RefreshToken_InvalidToken(t *testing.T) {
	...
	d.sessionRepo.EXPECT().GetByRefreshToken(gomock.Any(), "bad-token").Return(nil, domainauth.ErrSessionNotFound)

	c, w := handlertest.NewTestContext(http.MethodPost, "/auth/refresh", map[string]string{
...
func TestAuthHandler_Logout_NoToken(t *testing.T) {
	...
	c, w := handlertest.NewTestContext(http.MethodPost, "/auth/logout", nil)
	h.Logout(c)
...
func TestAuthHandler_Logout_Success(t *testing.T) {
	...
	c, w := handlertest.NewTestContext(http.MethodPost, "/auth/logout", map[string]string{
...
func TestAuthHandler_UpdateProfile_NoAuth(t *testing.T) {
	...
	c, w := handlertest.NewTestContext(http.MethodPatch, "/auth/me", map[string]string{
		"first_name": "Updated",
	})
	h.UpdateProfile(c)
...
func TestAuthHandler_UpdateProfile_Success(t *testing.T) {
	...
	c, w := handlertest.NewTestContext(http.MethodPatch, "/auth/me", map[string]any{
		"first_name": "Updated",
	})
	handlertest.SetAuthContext(c, uid)
	h.UpdateProfile(c)
...
func TestAuthHandler_ChangePassword_NoAuth(t *testing.T) {
	...
	c, w := handlertest.NewTestContext(http.MethodPost, "/auth/change-password", map[string]string{
