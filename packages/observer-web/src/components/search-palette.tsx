...
export function SearchPalette({ open, onOpenChange }: SearchPaletteProps) {
  ...
  return (
    <Command.Dialog
      ...
      overlayClassName="fixed inset-0 z-[199] bg-black/40 backdrop-blur-sm"
    >
      <div className="w-full max-w-lg overflow-hidden rounded-xl border border-border-secondary bg-bg shadow-elevated">
        ...
        <Command.List className="max-h-[60vh] overflow-y-auto p-2">
          ...
          {showViewAll && (
            <Command.Item
              ...
              className="mt-1 flex cursor-pointer items-center gap-2 rounded-lg border border-border-secondary px-3 py-2 text-sm text-accent outline-none data-[selected]:bg-bg-tertiary"
            >
        ...
        >
          {group.people.map((p) => (
            <Command.Item
              ...
              className="flex cursor-pointer items-center gap-2 rounded-lg px-3 py-1.5 text-sm text-fg outline-none data-[selected]:bg-bg-tertiary"
            >
