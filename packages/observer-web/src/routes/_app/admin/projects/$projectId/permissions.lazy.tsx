...
export const Route = createLazyFileRoute("/_app/admin/projects/$projectId/permissions")({
    ...
    },
    {
      ...
      render: (p) => (
        <div className="flex gap-1">
          ...
          {p.can_export && <StatusBadge label={t("admin.permissions.export")} variant="foam" />}
          {!p.can_view_contact &&
            !p.can_view_personal &&
            !p.can_view_documents &&
            !p.can_export && <span className="text-xs text-fg-tertiary">-</span>}
        </div>
      ),
    },
    {
