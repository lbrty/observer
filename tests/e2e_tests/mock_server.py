"""Taken from aiobotocore tests
https://github.com/aio-libs/aiobotocore/blob/master/tests/mock_server.py
"""
import asyncio
...
# aiobotocore
from tests.e2e_tests.moto_server import get_free_tcp_port, host
...
class AIOServer(multiprocessing.Process):
    ...
    def __init__(self):
        ...
        self.endpoint_url = f"http://{host}:{self._port}"  # noqa
    ...
    async def stream_handler(self, request):
        ...
        resp = StreamResponse(status=200, reason="OK", headers={"Content-Type": "text/html"})
